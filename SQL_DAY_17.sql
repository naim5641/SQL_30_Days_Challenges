...
-- this problem is new for me didnot solve this type of problem previously.
...
select
	del_partner,
	count(order_id) as cnt_de_dlv
	--sum(case when predicted_time < delivery_time then 1 else 0)  
from 
	order_details 
where
